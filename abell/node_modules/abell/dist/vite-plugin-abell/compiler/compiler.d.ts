...
export declare function compile(abellTemplate: string, options: HTMLOutputCompileOptions): AbstractSyntaxArrayType;
export declare function compile(abellTemplate: string, options: JSOutputCompileOptions): string;
